...
setwd('C:/Users/fabri/Dropbox/UFF/2021/02 Segundo Semestre 2021/Disciplinas/Trabalho de Conclus�o de Curso II - Bacharelado/C�digos do R/SMS - Experimentos para o TCC/SVR_MSE_GA_Corr_1') #Define a pasta de arquivos onde ser�o salvos os arquivos de simula��o, de ordenamento pela RF, do corte pelo SVR e do refinamento pelo GA.
...
list.snp<-list(1,2,3,4,5,6,7,8)  #Indica quais s�o os marcadores causais
list.ia<-list(1,2,3,-1,-2,-3,1,2)  #Contru��o das intera��es entre os 5 marcadores causais
