...
setwd('C:/Users/fabri/Dropbox/UFF/2021/02 Segundo Semestre 2021/Disciplinas/Trabalho de Conclusão de Curso II - Bacharelado/Códigos do R/SMS - Experimentos para o TCC/SVR_MSE_GA_R2_adj_5') #Define a pasta de arquivos onde serão salvos os arquivos de simulação, de ordenamento pela RF, do corte pelo SVR e do refinamento pelo GA.
...
save.image(file="SMS_R2_adj_5.RData")
